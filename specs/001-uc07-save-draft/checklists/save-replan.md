...
- [ ] CHK004 Are submit-triggered pre-validation save requirements fully specified as part of submission flow? [Completeness, Spec §FR-014, Spec §FR-015]
...
- [ ] CHK007 Is "no new changes" detection defined with deterministic comparison scope? [Clarity, Spec §FR-005]
- [ ] CHK008 Is submit sequencing unambiguous: save-equivalent persistence first, then final validation, then finalization decision? [Clarity, Spec §FR-014, Spec §FR-015]
...
- [ ] CHK011 Do FR-012 through FR-015 consistently align final-submission blocking with submit-triggered draft persistence? [Consistency, Spec §FR-012, Spec §FR-013, Spec §FR-014, Spec §FR-015]

## Acceptance Criteria Quality

- [ ] CHK012 Are SC-001 through SC-006 objectively measurable with explicit evidence sources and counting rules? [Acceptance Criteria, Spec §SC-001, Spec §SC-002, Spec §SC-003, Spec §SC-004, Spec §SC-005, Spec §SC-006]
- [ ] CHK013 Is SC-006 precisely measurable for "persist before validation" ordering evidence? [Measurability, Spec §SC-006]
...
- [ ] CHK018 Are requirements now explicitly defined for user selecting Submit with unsaved edits, including persistence-first behavior when final validation fails? [Coverage, Spec §Session 2026-02-10, Spec §FR-014, Spec §FR-015]
...
- [ ] CHK022 Are performance requirements specified for manual save and submit-triggered pre-validation save latency? [Non-Functional, Gap]
...
- [ ] CHK024 Are accessibility requirements defined for save status, error, no-change, and submit-validation feedback presentation? [Non-Functional, Gap]
...
- [ ] CHK027 Are persistence dependency requirements defined for cross-session durability and submit-triggered save guarantees? [Dependency, Spec §FR-006, Spec §FR-014, Gap]
