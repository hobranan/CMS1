...
| 2026-02-21 | Preserved raw API tester as `/appsimple/` | `frontend/src/appsimple/*`, `backend/src/server.js` | Keep low-level diagnostics while building a higher-level UX surface. |
